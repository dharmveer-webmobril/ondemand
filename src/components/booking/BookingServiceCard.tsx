                                ...
                                <View style={styles.appliedOfferContent}>
                                    <View style={styles.appliedOfferInfo}>
                                        <CustomText style={styles.appliedOfferTitle}>
                                            {appliedOffer?.title ?? ''} ({appliedOffer?.discountValue ?? 0}% Off)
                                        </CustomText>
                        ...
                        <View style={styles.priceSummaryContainer}>
                            {service.price !== undefined && (
                                <View style={styles.priceRow}>
                                    ...
                                    <CustomText style={styles.priceValue}>${(Number.isFinite(service?.price) ? service.price : 0).toFixed(2)}</CustomText>
                                </View>
                            )}
                            {service.addOnsTotal !== undefined && service.addOnsTotal > 0 && (
                                <View style={styles.priceRow}>
                                    <CustomText style={styles.priceLabel}>Add-ons:</CustomText>
                                    <CustomText style={styles.priceValue}>${(Number.isFinite(service?.addOnsTotal) ? service.addOnsTotal : 0).toFixed(2)}</CustomText>
                                </View>
                            )}
                            {service.totalAmount !== undefined && (
                                <View style={styles.priceRow}>
                                    <CustomText style={styles.priceLabel}>Subtotal:</CustomText>
                                    <CustomText style={styles.priceValue}>${(Number.isFinite(service?.totalAmount) ? service.totalAmount : 0).toFixed(2)}</CustomText>
                                </View>
                            )}
                            {service.discountAmount !== undefined && service.discountAmount > 0 && (
                                <View style={styles.priceRow}>
                                    ...
                                    <CustomText style={[styles.priceValue, styles.discountText]}>
                                        -${(Number.isFinite(service?.discountAmount) ? service.discountAmount : 0).toFixed(2)}
                                    </CustomText>
                                </View>
                            )}
                            {service.discountedAmount !== undefined && (
                                <View style={[styles.priceRow, styles.totalPriceRow]}>
                                    ...
                                    <CustomText style={styles.totalPriceValue}>
                                        ${(Number.isFinite(service?.discountedAmount) ? service.discountedAmount : 0).toFixed(2)}
                                    </CustomText>
                                </View>
                            )}
                        </View>
