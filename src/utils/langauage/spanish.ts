export const spanish = {
  ...
  "bookAppointment": {
    ...
    "selectedPreference": "Tu preferencia seleccionada:",
    "bookingType": "Tipo de reserva",
    "singleBooking": "Reserva única",
    "routinePackage": "Paquete de rutina",
    "routineHowItWorks": "Cómo funciona la reserva de rutina",
    "routineStep1": "Paso 1: Elige una fecha (dentro de 90 días) y un horario.",
    "routineStep2": "Paso 2: Toca \"Agregar esta fecha y hora a la rutina\".",
    "routineStep3": "Paso 3: Repite para cada sesión (mín. 2, máx. 24).",
    "advanceNotice24h": "Aviso previo: 24 h",
    "noSameDay": "No se permite el mismo día",
    "volumeDiscountTiers": "Niveles de descuento por volumen",
    "volumeDiscountSubtitle": "Descuento aplicado al paquete completo según las sesiones reservadas.",
    "sessionsCol": "Sesiones",
    "discountCol": "Descuento",
    "tierCol": "Nivel",
    "currentTier": "Actual: {{tier}} ({{percent}}% dto.) · {{count}} sesiones",
    "sessionDate": "Fecha de sesión",
    "selectDate": "Seleccionar fecha",
    "selectDateTime": "Seleccionar fecha y hora",
    "selectTime": "Seleccionar hora",
    "addRoutineSession": "Agregar sesión",
    "confirmDateTime": "Confirmar",
    "addToRoutine": "Agregar esta fecha y hora a la rutina",
    "tapToSelectDateTime": "Toca para seleccionar fecha y hora",
    "tapToAddSession": "Toca para agregar fecha y hora",
    "routineDateHint": "Las sesiones de rutina deben estar dentro de los próximos {{days}} días (máx. {{maxDate}}).",
    "sessionsAdded": "{{count}} sesión(es) agregada(s) (mín. {{min}}, máx. {{max}})",
    "routineMinSessions": "Agrega al menos {{min}} sesiones para un paquete de rutina.",
    "routineMaxSessions": "Puedes agregar hasta {{max}} sesiones.",
    "routineDuplicateSession": "Esta fecha y hora ya están en tu rutina.",
    "routineSessionAdded": "Sesión agregada a la rutina.",
    "packageSummary": "Resumen del paquete",
    "subtotal": "Subtotal",
    "volumeDiscount": "Descuento por volumen ({{tier}} {{percent}}%)",
    "packageTotal": "Total del paquete",
    "routineNoPromos": "Las promociones no aplican a paquetes de rutina.",
    "sessionsLabel": "sesiones",
    "sessionsAddedShort": "{{count}} sesiones programadas",
    "sessionSchedule": "Calendario de sesiones",
    "viewSessionSchedule": "Ver calendario de sesiones",
    "hideSessionSchedule": "Toca para contraer",
    "scrollSessions": "Desplázate para ver más",
    "removeSession": "Eliminar sesión",
    "routineAvailableBadge": "Rutina",
    "routineNotAvailable": "Rutina no disponible",
    "routineNotAvailableHint": "Este servicio no admite paquetes de rutina.",
    "routineOnlyServicesHint": "Solo los servicios con reserva de rutina pueden agregarse a un paquete.",
    "preferenceNotAvailable": "No disponible para {{preference}}",
    "singlePreferenceHint": "Solo se pueden agregar servicios disponibles para tu preferencia ({{preference}}).",
    "switchToRoutineAlert": "Tus servicios seleccionados solo admiten paquetes de rutina. Cambia a Rutina para agregar este servicio.",
    "switchToRoutineRemoveAlert": "Seleccionaste servicio(s) sin rutina: {{names}}. Al cambiar a Rutina se eliminarán.",
    "switchToRoutineConfirm": "Cambiar a Rutina",
    "stayOnSingle": "Cancelar",
    "noRoutineServicesAfterSwitch": "Selecciona al menos un servicio con rutina para usar el modo Rutina.",
