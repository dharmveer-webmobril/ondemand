...
const CustomTextInputStyles = (theme: ThemeType, isDisabled: boolean, inputTheme = '', withBackground = "transparent", multiline = false) => {
    ...
    return StyleSheet.create({
        ...
        inputContainer: {
            ...
            alignItems: "center",
            borderWidth: 1,
            borderColor: inputTheme === 'white' ? theme.colors.white : (isDisabled ? colors.gray ?? colors.textInputBorder : colors.textInputBorder),
            borderRadius: size.SF(10),
            paddingHorizontal: size.SF(10),
            paddingVertical: margins.sm,
            backgroundColor: isDisabled ? (colors.background ?? colors.gray ?? '#F5F5F5') : (withBackground ? colors.white : "transparent"),
        ...
        inputStyle: {
            ...
            color: inputTheme === 'white' ? theme.colors.white : (isDisabled ? (colors.lightText ?? colors.gray ?? '#999999') : colors.text),
